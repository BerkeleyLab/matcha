...
echo "fpm command to the build/run-fpm.sh script. For example, to"
echo "run the Matcha test suite in a single image execute the"
echo "following command in a Linux or macOS shell:"
echo ""
echo "./$RUN_FPM_SH test --flag -fcoarray=single"
echo ""
echo "For parallel execution instructions, please see the README.md file."
