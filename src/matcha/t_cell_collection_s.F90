...
contains
  ...
  module function construct(positions, time) result(t_cell_collection)
  ...
  module function positions(self) result(my_positions)
  ...
  module function time(self) result(my_time)
