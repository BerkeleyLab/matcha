...
contains
  ...
  module procedure construct
    ...
    associate(nintervals => size(sample_distribution,1))      
      ...
      call_assert_diagnose(monotonically_increasing(distribution%cumulative_distribution_), "distribution_t: monotonically_increasing(distribution%cumulative_distribution_)", intrinsic_array_t(distribution%cumulative_distribution_))
