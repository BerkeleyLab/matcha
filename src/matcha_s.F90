  ...
  module procedure matcha
    ...
    associate( &
      ...
      block
        ...
        type(distribution_t) distribution_angle
        integer, parameter :: nveldim = 5
        integer step
        ...
        associate(me => this_image())
          associate(my_num_cells => data_partition%last(me) - data_partition%first(me) + 1)
            ...
            associate(nsteps => npositions -1)
              ...
              distribution = distribution_t(empirical_distribution,empirical_angle_distribution)
              associate(random_speeds=>random_4vectors(:,:,1),random_directions=>random_4vectors(:,:,3:5))
                associate(random_angles => random_4vectors(:,:,2))
                  associate(v => distribution%velocities(random_speeds,random_angles,random_directions))
